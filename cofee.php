...
<?php if ( is_day() ) : ?>
                <h1 class="page-title"><?php printf( __( 'Daily cofee: <span>%s</span>', 'your-theme' ), get_the_time(get_option('date_format')) ) ?></h1>
<?php elseif ( is_month() ) : ?>
                <h1 class="page-title"><?php printf( __( 'Monthly cofee: <span>%s</span>', 'your-theme' ), get_the_time('F Y') ) ?></h1>
<?php elseif ( is_year() ) : ?>
                <h1 class="page-title"><?php printf( __( 'Yearly cofee: <span>%s</span>', 'your-theme' ), get_the_time('Y') ) ?></h1>
<?php elseif ( isset($_GET['paged']) || !empty($_GET['paged']) ) : ?>
                <h1 class="page-title"><?php _e( 'Blog cofee', 'your-theme' ) ?></h1>
<?php endif; ?>
